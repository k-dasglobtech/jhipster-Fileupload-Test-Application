...
@NgModule({
  imports: [JhipsterFileuploadTestApplicationSharedModule, RouterModule.forChild(ENTITY_STATES)],
  declarations: [
    JobHistoryComponent,
    JobHistoryDetailComponent,
    JobHistoryUpdateComponent,
...
export class JhipsterFileuploadTestApplicationJobHistoryModule {}
